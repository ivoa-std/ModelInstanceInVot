...
\begin{itemize}
  ...
  \item The above cases relate to the processing of individual datasets; %(NFB : I don't understand why we are talking of datasets here. What kind of datasets are we talking about ? Rows in the table ? measurements ? )
  
  the model annotations become even more important for cases where a good level of interoperability is required to match different datasets. %(NFB : same question as above )
