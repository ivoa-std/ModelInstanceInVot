...
\begin{lstlisting}[caption={Example of \texttt{INSTANCE} child of \texttt{INSTANCE}.},language=XML]
...
%mir : this list gathers the xml attributes explained in the text just before 
%mir:  could we put it at the beginning of the section , just after the first sentence ("..... ObjectType or DataType.") which could be followed by :

The various XML attributes for an \texttt{INSTANCE} element, will have constraints depending on there usage .
