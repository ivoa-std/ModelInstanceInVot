...
% It has however a number of limitations that have been discussed many times:
...
In \texttt{VODML}, model leaves role are no longer given by simple strings like UTypes, but by the local role they play in the model hierarchy
