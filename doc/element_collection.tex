...
\begin{lstlisting}[caption={Example of \texttt{COLLECTION} child of \texttt{GLOBALS} (see line~\ref{COLLECTION_snippet_1} in Appendix A). It plays no specific role as being part of the \texttt{GLOBALS} elements.},language=XML]
<GLOBALS>
    <!--
...
\begin{lstlisting}[caption={Example of \texttt{COLLECTION} populated with a JOIN (see line~\ref{COLLECTION_snippet_2} in Appendix A).},language=XML]
