    ...
    \item{As child of GLOBALS}
      ...
      %(FB: why a "proxy for TABLE" ? this means that this is the same IF of groupping several things (such as FIELDS or INSTANCES ?). And why PRIMARY KEY/FOREIGN_KEY ? I cannot see that in th schema. maybe INSTANCES containing PRIMAR_KEY for selection by FOREIGN_KEY ?
      Examples of usage in this context would be:
      \begin{itemize}
