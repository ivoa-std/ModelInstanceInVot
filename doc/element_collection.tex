...
\begin{lstlisting}[caption={Example of \texttt{COLLECTION} child of \texttt{GLOBALS} (see line~\ref{COLLECTION_snippet_1} in Appendix A). It plays no role as a \texttt{GLOBALS} element.},language=XML]
<GLOBALS>
    <!--
