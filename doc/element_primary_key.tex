The PRIMARY\_KEY element allows to set an identification key to an INSTANCE. The primary keys are only used in the context of REFERENCEs using FOREIGN\_KEY.
