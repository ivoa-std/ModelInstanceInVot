...
\begin{lstlisting}[caption={The \texttt{INSTANCE} is identified within a \texttt{COLLECTION} by the \texttt{PRIMARY\_KEY} value (see \ref{PRIMARY_KEY_snippet}).},language=XML]
