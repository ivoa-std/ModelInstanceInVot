...
These excerpts are out of the box, they refer to model elements or VOTable metadata that do not exist 
but that have been chosen to achieve better readability. 
Readers can have a look at \texttt{https://github.com/ivoa-std/ModelInstanceInVot/tree/master/data-sample} 
to retrieve most of them in a context of real data.
