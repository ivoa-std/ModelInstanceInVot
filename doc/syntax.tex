...
The values of both \texttt{@dmrole} and \texttt{@dmtype} are constructed by taking the vodml-id 
of the respective VO-DML elements and prefixing it with the canonical 
short name of the model and a colon.
...
Each element subsection comes with 2 or 3 tables: 1) one giving the role of each attribute, 
