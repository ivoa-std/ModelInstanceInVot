...
\begin{lstlisting}[caption={Example \texttt{TEMPLATES} block},language=XML]
<VODML xmlns="http://www.ivoa.net/xml/merged-syntax">
  <MODEL name="sample" url="https://www.ivoa.net/xml/DNE/Sample-v1.0.vo-dml.xml" />
  <MODEL name="ivoa"   url="https://www.ivoa.net/xml/IVOA-v1.vo-dml.xml" />
  <TEMPLATES tableref='Results'>
    <!-- instance template -->
    <INSTANCE dmtype="sample:Thing">
      <ATTRIBUTE dmrole="sample:Thing.name" dmtype="ivoa:string" ref="_field1"/>
      <ATTRIBUTE dmrole="sample:Thing.date" dmtype="ivoa:string" ref="_field2"/>
      ...
    </INSTANCE>
  </TEMPLATES>
</VODML>
