...
data model elements (class, attributes, types, etc.) expressed in the standard Virtual Observatory Data Modeling Language (here after VO-DML).
...
The MIVOT syntax allows to describe the basic data structures, but also to show bindings and relations between them in one single table. 
...
These bricks are reused as well on the client side generate data model instances .
