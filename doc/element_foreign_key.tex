...
\begin{lstlisting}[caption={The \texttt{REFERENCE} is resolved by the \texttt{INSTANCE} of the table \texttt{\_CoordinateSystems} that has a primary key equals to the value of the column  \texttt{\_band} (see line~\ref{FOREIGN_KEY_snippet} in Appendix A).},language=XML]
