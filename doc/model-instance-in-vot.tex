...
\begin{itemize}
 ...
 % Not sure we keep it  \item The mapping syntax must be able to group data rows in an set of instances.
\end{itemize}
\end{itemize}
...
\bibliography{ivoatex/ivoabib,ivoatex/docrepo, model-instance-in-vot}
