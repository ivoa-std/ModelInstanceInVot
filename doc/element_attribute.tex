...
\end{tabulary}
     \caption{Valid attribute patterns for \texttt{ATTRIBUTE}. (1) Valid in a TEMPLATES context.        
        ...
        The @ref can not be resolved and @value is present, @value must taken. Either @ref of @value must be present or both (2) This pattern 
        is valid in a any context.  (3) is vali in the context of a COLLECTION item.    
