...
def main():
    ...
    mapping_generator.root_object_id = 'meas:Time'
    # set the concrete object types
    mapping_generator.concrete_classes = {
        "coords:PhysicalCoordSys.frame": ["coords:TimeFrame"],
        "coords:Coordinate.coordSys": ["coords:TimeSys"],
        }
    # set the concrete data types
    mapping_generator.concrete_types={
        "coords:TimeFrame.refPosition": "coords:StdRefLocation",
        "coords:TimeFrame.refDirection": "coords:StdRefLocation",
        "meas:Error.statError": "meas:Symmetrical",
        "meas:Error.sysError": "meas:Symmetrical",
        "meas:Time.coord": "coords:MJD"
