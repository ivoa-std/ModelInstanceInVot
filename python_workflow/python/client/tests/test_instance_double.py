...
class TestInstance(unittest.TestCase):
    ...
    def test_1(self):
        ...
        votable_path = os.path.join(votable_path, "./data/test_instance_double.xml")
        json_ref_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "./data/test_instance_double.json")
